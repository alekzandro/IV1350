...
public void setUp() {
	...
	sampleItemDTO1 = new ItemDTO(5, "A", "A", 10, 10);
	sampleItemDTO2 = new ItemDTO(6, "B", "B", 20, 20);
	sampleItemDTO3 = new ItemDTO(7, "C", "C", 30, 30);
	sampleItemDTO4 = new ItemDTO(8, "D", "D", 40, 40);
	sampleItemDTO5 = new ItemDTO(9, "E", "E", 50, 50);
	sampleItemDTO6 = new ItemDTO(55, "E", "E", 60, 60);
...
public void testItemPrice() {
	...
	assertEquals(10, summary.getPriceOfLastAddedItem(), 0);
...
public void testRunningTotal() {
	...
	saleToTest.addItem(sampleItemDTO1);
	SummaryOfRunningSaleDTO summary = saleToTest.getSummaryOfRunningSale(sampleItemDTO1);	
	assertEquals(200, summary.getTotalPriceOfSale(), 0);
...
public void testTotalPrice() {
	...
	assertEquals("Incorrect total price", 110, price);
...
public void testTotalPriceIncludingVAT() {
	...
	assertEquals("Incorrect total price", 360, price);
...
public void testApplyDiscount() {
	...
	int price = (int) saleToTest.getTotalPriceIncludingVAT();
	assertEquals("Incorrect total price", 306, price);
